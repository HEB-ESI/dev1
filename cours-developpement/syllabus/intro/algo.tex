...
% ========================================================================
	...
	%----------------------------------
		...
		%----------------------
			...
			Un algorithme en \textbf{langage naturel} pourrait être~: 
			
			\begin{langagenaturel}		
			En connaissant le rayon, le calcul de la circonférence se fait grâce
			à  $$p = 2\pi r$$
			\end{langagenaturel}
...
public class CircleCircumference{
	public static double circleCircumference(double radius){
		...
		%-------------------------------------------------------
			...
			Le \textbf{software} et plus précisément le système d'exploitation,

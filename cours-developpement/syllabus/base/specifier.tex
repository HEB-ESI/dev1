...
%==============================
	...
	%----------------------------------------------
		...
		\marginicon{definition}\index{variable}
	...
	%----------------------------------------------
		...
		Certains langages imposent et vérifient le type de chaque varible tandis
		...
		%-----------------------------------------
			...
			Nous pourrons alors définir et utiliser un type \pc{Date}

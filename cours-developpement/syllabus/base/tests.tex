...
Tous les programmes contiennent des erreurs, des \textit{bugs}, des défauts\dots{} Ces
...
\textbf{Test unitaire} Procédure permettant de tester le bon fonctionnement d'une unité de code, une méthode \bsc{Java} dans notre cas. En fonction des paramètres qu'elle reçoit en entrée, la

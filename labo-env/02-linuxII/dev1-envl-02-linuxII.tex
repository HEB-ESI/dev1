...
%=====================
	...
	%==================================
		...
		\begin{Exercice}{Utilisation d'un chemin (2)}
			On voudrait créer une copie du fichier \samp{welcome} (vu ci-dessus)
			dans le dossier \samp{\textasciitilde{}/dev1/td2}.
			\begin{enumerate}
			\item 
...
%=====================
	...
	%====================
		...
		\begin{Exercice}{Trouver la bonne option} 
			La commande \kbd{ls -l /bin} 
			affiche le contenu du dossier en format \textit{long}.
			La 5\ieme{} colonne donne la taille du fichier (en octets).
			Lorsque les nombres sont grands, ce n'est pas très lisible : un fichier de 13503094 octets, est-ce approximativement 1 Mo, ou 10 Mo ou 100 Mo ? Il faut compter les chiffres pour en être sûr.
			Trouvez une option qui permet d'afficher cette taille sous un format plus lisible.  
	...
	%====================
		...
		\begin{Exercice}{Trouver la bonne option (II)}
			Quelqu'un m'a dit que la commande \kbd{ls} \samp{pouvait}

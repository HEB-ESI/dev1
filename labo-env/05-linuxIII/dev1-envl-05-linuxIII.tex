...
%====================
	...
	\begin{Exercice}{Compiler en bloc}
		...
		comment compiler facilement tous les fichiers Java du dossier \samp{td4}.
	\end{Exercice}
...
%====================
	...
	\\permet de trouver tous les fichiers java%
	\footnote{
...
%====================
	...
	Imaginons qu'un programme Java produise un gros output.
	...
	%===============================
		...
		\begin{Experience}{Rediriger la sortie d'un programme Java}
			...
			\item 
				...
				pour copier un programme Java qui produit un output très long.
			\item 
		...
		Ce qu'on vient de voir avec un programme Java est en fait
		...
		\begin{alerttbox}{Transparent pour les exécutables}
			...
			pour les commandes.
			Le programme Java n'a pas été modifié !
	...
	%===============================
		...
		En Java, le code \samp{System.out.println()}
		...
		Ceci explique pourquoi c'est une bonne pratique en Java
		...
		\begin{Exercice}{Recherche}
			...
			\footnote{%
				Un prochain TD sera consacré aux permissions sous Linux.
			}.
	...
	%===============================
		...
		\begin{Experience}{Rediriger l'entrée d'un programme Java}
			...
			\item 
				...
				pour copier un programme Java qui produit lit des nombres
...
%====================
	...
	\begin{Exercice}{Traiter les fichiers trouvés}
		Comment afficher le \textbf{contenu} de tous vos fichiers java ?

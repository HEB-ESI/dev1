...
%====================
	...
	%===============================
		...
		\begin{Experience}{Rediriger la sortie d'un programme Java}
			...
			créez un dossier \samp{td5} et placez-vous dedans.
			\begin{steps}
			\item 
	...
	%===============================
		...
		\begin{theorie}{Rediriger l'entrée}
			...
			\item \samp{< nomFichier} : 
				...
				mais \textbf{depuis le fichier} (qui doit exister).
			\end{itemize}
		\end{theorie}

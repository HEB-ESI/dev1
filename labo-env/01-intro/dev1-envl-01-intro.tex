...
%====================
	...
	\exergue{\name{Linux} ? Il y a moins bien mais c'est plus cher.}{Auteur inconnu}
	...
	%====================
		...
		\begin{theorie}{Linux}
			\begin{wrapfigure}{r}{0.4\textwidth} 
				...
				\vspace{-1em}
			\end{wrapfigure} 
			\name{Linux} est un système d'exploitation comme le sont 
			également \name{Windows} ou \name{MacOS}. 
			...
			\name{Linux} n'échappe pas à la règle et propose un environnement 
		...
		\begin{theorie}{Le mode console}
			...
			\item[Bash] 
				Plusieurs shells existent en \name{Linux}. Bash est l'un d'entre eux.
			\end{description} 
...
\newpage
	...
	%=====================
		...
		\begin{theorie}{Le répertoire personnel}
			Sur \name{Linux}, chaque utilisateur dispose d'un « \textbf{dossier personnel} » 
...
%====================
	...
	\begin{faq}
		...
		comment avoir facilement un \name{Linux} fonctionnel sur votre \name{PC}.

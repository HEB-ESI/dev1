...
%========================
	...
	%======================================
		...
		\begin{Exercice}{Groupe}
			...
			\item Créez un fichier de test et modifiez le groupe auquel il appartient.
                          Dans quel(s) groupes pouvez-vous placer ce fichier ?
                          
                          Sur linux1, pourriez-vous placer ce fichier dans le groupe \texttt{enseignants} ? Pourquoi ?
			\end{itemize}
		\end{Exercice}
	...
	%======================================
		...
		\item
			...
			Donc, le propriétaire (\samp{g12345}) 
		...
		\begin{Experience}{Permissions par défaut}
			...
			\begin{steps}
			\item Si ce n'est pas encore fait, créez un dossier \samp{dev1/td7}.
	...
	%=========================================
		...
		%======================================================
			...
			\begin{Exercice}{Modifier les permissions}
				Créez un fichier \samp{dev1/td7/brol} 
		...
		%======================================================
			...
			\begin{Exercice}{Modifier les permissions}
				Créez un fichier \samp{dev1/td7/brol2} 
				contenant un petit texte de votre choix.
				Faites en sorte qu'il soit modifiable par tout le monde
				mais lisible uniquement par vous.
                              \end{Exercice}
                        ...
                        \begin{Exercice}{Exécutabilité d'un programme java}
                          ...
                          Essayez à présent de permettre à votre voisin ou voisine de lire votre code source, et enfin essayez de l'empêcher d'exécuter votre fichier compilé.
                          Vérifiez avec elle ou avec lui à chaque étape.

                          [Si vous travaillez seul·e, vous devrez faire preuve d'imagination.
                          Alternativement, vous pouvez essayer de vous empêcher vous-même d'exécuter votre fichier.]
                        \end{Exercice}
	...
	%======================================================
		...
		\begin{alertbox}
			...
			qui, par expérience, vous pose souvent un problème.
                        ...
                        Toutefois si vous voulez expérimenter les cmomandes de cette section, cela suppose
                        que vous êtes connecté à \texttt{linux1} afin d'avoir accès au groupe \texttt{etudiants}.
		\end{alertbox}
		...
		\begin{Tutoriel}{Droit de lecture pour les enseignant uniquement}
			...
			\begin{steps}
			\item 
				Entrez \kbd{cd \textasciitilde/dev1/td7}
		...
		\begin{Exercice}{Un fichier réservé aux étudiants}
			Créez un fichier \samp{dev1/td7/gossip}
	...
	%======================================================
		...
		\begin{theorie}{Permissions sur un dossier}
			...
			\item[\samp{r} (lecture)] 
				...
				On peut par exemple faire \kbd{ls td7}.
			\item[\samp{w} (écriture)] 
				On peut modifier la « couverture » du dossier. 
				On peut ainsi effacer un fichier (\kbd{rm td7/brol2})
				ou en créer un (\kbd{touch td7/brol3}). 
			\item[\samp{x} (ouverture)]
				On peut « ouvrir » le dossier / entrer dedans. 
				On peut ainsi en faire son dossier courant (\kbd{cd td7}) 
				ou le traverser dans un chemin (\kbd{cat td7/gossip}).				
			\end{description}
		\end{theorie}
		...
		\begin{Exercice}{Les permissions sur un dossier (I)}           
			Dans un dossier \samp{dir1} dans votre dossier \samp{td7}.
		...
		\begin{Exercice}{Les permissions sur un dossier (II)}           
			Dans un dossier \samp{dir2} dans votre dossier \samp{td7}.
			Dans ce dossier, créez un fichier \samp{file}.
	...
	%================================
		...
		\begin{faq}
			...
			et plus lié à la structure interne du système de fichier : il s'agit du nombre de \emph{liens physiques} (\emph{hard links}) sur le fichier.
                        Pour la plupart des fichiers ce nombre sera égal à 1.
                        Pour la plupart des répertoires ce nombre sera égal à $2+n$, où $n$ est le nombre de sous-répertoires qui s'y trouvent.

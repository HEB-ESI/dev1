...
%========================
	...
	Comme \name{Linux} est un système partagé, il est important de parler de sécurité. 
	...
	%======================================
		...
		\begin{theorie}{Les groupes}
			Les utilisateurs d'un système \name{Linux} sont placés 
			dans des \textbf{groupes}. 
		...
		\begin{Exercice}{Visualiser les groupes}
			...
			\begin{itemize}
				...
				\item Quel(s) groupe(s) \name{Linux} avez-vous en commun avec les 
		...
		\begin{colxbox}[colback=white,drop fuzzy shadow]
			...
			\footnote{
				...
				Sur \name{Linux}, on dit aussi le « super user », 
	...
	%================================
		...
		\begin{faq}
			...
			\medskip
			\textbf{%
				J'ai un \name{Linux} à la maison et les groupes ne sont pas les mêmes. 
				C'est normal ?
			}

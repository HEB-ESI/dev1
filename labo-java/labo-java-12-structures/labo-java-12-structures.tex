...
%====================	
	...
	Nous vous proposons d'écrire une méthode qui permet de \og traduire\fg{} une instance \texttt{Etudiant} en une chaîne de caractères. Nommons cette méthodes \texttt{toString} ; la signature de la méthode sera donc \code{java}{String toString(Etudiant e)}.

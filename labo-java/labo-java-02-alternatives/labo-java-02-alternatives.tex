...
%====================	
	...
	\bigskip
 	\listing{java}{\detokenize{code/Calculs.java}}
...
\section{Les conditions}
	...
	\begin{itemize}
		\item \code{java}{age < 18}~:   \texttt{age} a une valeur inférieure à 18~;
		\item \code{java}{nb >= 0}~:  \texttt{nb} est supérieur à 0~;
		\item \code{java}{b*b - 4*a*c < 0}~:le delta $b^2-4ac$ est négatif~;
		\item \code{java}{nb >= 0 \&\& nb <=100}~: le nombre \texttt{nb} est compris entre 0 et 100~;
		\item \code{java}{a < b}~:  la valeur de la variable \texttt{a} est inférieure à celle de \texttt{b}.
	\end{itemize}
...
\section{Les alternatives: \texttt{if/else}}
	...
	si \texttt{nb} est plus grand ou égal à 0 et n'affichera rien dans le cas contraire.
	 ...
	 \listing{java}{code/Positif.java}
...
\section{Exercices supplémentaires}
	...
	\begin{Exercice}{Les intérêts}
		Dans une classe \texttt{Placement} écrivez un programme qui demande un montant (un nombre réel)
	...
	\begin{Exercice}{Prix TTC}
		Dans une classe \texttt{TTC} écrivez un programme qui demande à l'utilisateur:
		\begin{itemize}

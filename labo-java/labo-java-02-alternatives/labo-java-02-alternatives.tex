...
\section{Les conditions}
	...
	\begin{tabular}{lll}\toprule
		...
		plus petit         & <        & \code{java}{a < 10}\\
		plus petit ou égal & <=       & \code{java}{a <= 10} \\
		plus grand         & >        & \code{java}{a > 18} \\
		plus grand ou égal & >=       & \code{java}{a >= 21} \\
		 égal              & ==       & \code{java}{a == 4}\\
		 différent         & !=       & \code{java}{a != 42}\\ \bottomrule
	\end{tabular} 
      \end{center}
...
\section{Exercices supplémentaires}
	...
	\begin{Exercice}{Divisions entière et réel}

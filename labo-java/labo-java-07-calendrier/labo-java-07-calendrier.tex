...
\seance{7}{Mise en pratique : un calendrier}{td07-calendrier}{
...
$((3 + 10 + 8 + 2 + 5 + 100 + 5) \mod 7) = (133 \mod 7) = 0$ et donc lundi.  
	...
	Terminez votre application en y insérant le décalage obtenu avec cette
	méthode \texttt{numéro\-Jour}.

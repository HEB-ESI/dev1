...
\seance{X}{Une introduction à Git sous NetBeans}{tdX-git}{
...
%------------------------------------------------------------------
	...
	\begin{steps}
	\item
		Créez un nouveau projet \bsc{NetBeans} appelé \samp{TestGit}.
		Ce projet sera constitué  :
		\begin{itemize}
		\item 
			d'un package \samp{dev1.javl} ;
		\item
			d'une classe principale appelée \samp{MainApp}
			qui affiche le numéro de version du projet.
		\end{itemize}
		\begin{center}
			\includegraphics[width=.8\textwidth]{image/NetBeans_Project_01.png}
		\end{center}
	\item 
...
%------------------------------------------------------------------
	...
	\item 
		...
		\begin{center}
			\includegraphics[width=.65\textwidth]{image/NetBeans_Push02.png}
		\end{center}
	\end{steps}
	...
	\begin{center}
		\includegraphics[width=.7\textwidth]{image/NetBeans_Push03.png}
	\end{center}

...
\seance{3}{Alternatives}{td03-alternatives}{
	Dans ce TD vous trouverez une introduction aux expressions booléennes
	et à l'instruction \texttt{if/else}.
}
...
\listing[basicstyle=\footnotesize\vtt]{java}{Positif.java}
